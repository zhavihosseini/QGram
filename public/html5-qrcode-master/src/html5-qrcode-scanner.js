...
class Html5QrcodeScanner {
    ...
    __createHeader(dashboard) {
        ...
        titleSpan.innerHTML = "Q Gram Scanner";
    ...
    __createSectionControlPanel() {
        ...
        const requestPermissionButton = document.createElement("button").style='outline=none';
    ...
    __insertCameraScanImageToScanRegion() {
        ...
        this.cameraScanImage.style.marginRight=0;
        this.cameraScanImage.style.display='inline';
    ...
    __insertFileScanImageToScanRegion() {
        ...
        this.fileScanImage.style.display='inline';
    }
