    ...
    <div class="container" id="cont">
        <div class="row col-md-12" style="margin-left: 0px;padding: 0px">
            <div class="col-md-12">
                ...
                <br>
                <form action="<?php echo route('urls')?>" method="post">
                    <?php
                    echo csrf_field();
                    ?>
                    <div class="form-group">
                        <label for="url">Url:</label>
                        <input type="text" class="form-control bx-bitcoin" id="url" placeholder="Enter Your Url with http://..." name="url" required max="255"/>
                    </div>
                    <div class="form-group">
                        <label for="describe">Description:</label>
                        <input type="text" class="form-control bx-bitcoin" id="describe" placeholder="Enter Your Description..." name="describe" required max="255"/>
                    </div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-10 col-md-10">
                                                        ...
                                                        <div class="action">
                                                            <form method="get" action="<?php echo route('editurl',['id'=>$id])?>" class="inline-flex">
                                                                @csrf
                                                                    ...
                                                                    <div class="modal-dialog modal-lg">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-footer justify-content-between">
                                                                                ...
                                                                                <form method="get" action="<?php echo route('deleteurl',['ids'=>$id])?>">
