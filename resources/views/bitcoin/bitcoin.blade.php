   ...
   {{-- <x-slot name="header">
    ...
    <div class="container" id="cont">
        <div class="row col-md-12" style="margin-left: 0px;padding: 0px">
            <div class="col-md-12">
                <strong>Create Your Bitcoin QR Code</strong>
                <br>
                <form action="<?php echo route('bitcoinn')?>" method="post">
                    <?php
                    echo csrf_field();
                    ?>
                    <div class="form-group">
                        <label for="Amount">Amount:</label>
                        <input type="text" class="form-control bx-bitcoin" id="amount" placeholder="Enter Amount 0.334BTC" name="amount" max="255"/>
                    </div>

                    <div class="form-group">
                        <label for="Receiver">Receiver:</label>
                        <input type="text" class="form-control" id="receiver" placeholder="Enter Bitcoin Address" name="receiver" max="255"/>
                    </div>
                    <div class="form-group">
                        <label for="Message">Message:</label>
                        <input type="text" class="form-control" id="message" placeholder="Enter your Message" name="Message" required max="255"/>
                    </div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-10 col-md-10">
                                                        ...
                                                        <div class="action">
                                                            <form method="get" action="<?php echo route('updates',['id'=>$id])?>" class="inline-flex">
                                                                @csrf
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-footer justify-content-between">
                                                                                <button type="button" class="btn btn-light" data-dismiss="modal">Close</button>
                                                                                    <form method="get" action="<?php echo route('deletee',['ids'=>$id])?>">
