        ...
        <nav class="nav-menu d-none d-lg-block">
            <ul>
                @if (Route::has('login'))
                    ...
                    @endif
                @endif
                <li><a href="<?php echo route('home')?>">{{__('index.homee')}}</a></li>
                {{--
...
<ul>
    ...
    <li>
        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Q Gram.</p>
    </li>
    <li>
    ...
    <li>
        <p><strong>Website</strong> refers to Q Gram, accessible from <a href="localhost/qgram" rel="external nofollow noopener" target="_blank">localhost/qgram</a></p>
    </li>
    <li>
...
<ul>
    <li>By visiting this page on our website: <a href="<?php echo route('privacy')?>" rel="external nofollow noopener" target="_blank">Privacy-policy</a></li>
</ul>
</div>
