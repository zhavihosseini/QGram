...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Sessions to ({{$name}})</h1>
                    @endforeach
                </div>
                <!-- /.col-lg-12 -->
            </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body bg-dark" style="overflow-y: auto;max-width: 10200px">
                            <table class="table table-hover table-dark" style="border-bottom: 1px solid lightgrey">
                                <thead>
                                <form method="get" action="<?php echo route('sendeemail',['id'=>$hash])?>" style="text-align: center;background-color: lightgrey">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" style="text-align: center;font-weight: bold">
                            For Send An Alert to User Dashboard
                        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading" style="text-align: center;font-weight: bold">
                        For Send An Email To All User
                    </div>
                    <div class="panel-body bg-dark hover:text-gray-900" style="overflow-y: auto;max-width: 10200px">
                        <div class="col-md-12">
                            <div class="panel-heading panel-default" style="text-align: center;background-color: lightgrey">
                                <form method="get" action="<?php echo route('sendemailusers')?>" style="text-align: center;background-color: lightgrey">
                                    <input type="text" name="subject" required placeholder="Subject" style="margin: 7px"/>
                                    <input type="text" name="content" required placeholder="Content" style="margin: 7px"/>
                                    <input type="text" name="link" required placeholder="Link" style="margin: 7px"/>
                                    <input type="text" name="linkcontent" required placeholder="link Content" style="margin: 7px"/>
