...
@else
    <div class="container">
        ...
        <button style="margin-bottom: 10px;" class="btn btn-danger delete_all center-block justify-content-center" data-url="{{ url('myproductDeleteurl') }}">Delete All Selected</button>
            ...
            @if($url->count())
                @foreach($paginate as $key => $product)
                    <tr id="tr_{{$product->id}}">
                        ...
                        <td>
                            <a href="{{ url('myproductsurl',$product->id) }}" class="btn btn-danger btn-sm"
