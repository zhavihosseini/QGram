    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Send Email to ({{$all}}) Email</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading" style="text-align: center;font-weight: bold">
                                For Send An Email To All Users
                            </div>
                            <div class="panel-body bg-dark" style="overflow-y: auto;max-width: 10200px">
                                <table class="table table-hover table-dark" style="border-bottom: 1px solid lightgrey">
                                    <thead>
                                    <form method="get" action="<?php echo route('allusers')?>" style="text-align: center;background-color: lightgrey">
