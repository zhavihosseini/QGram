...
@else
    <div class="container">
        <h3 style="text-align: center">Multiple Deleted <strong>Url</strong> Row</h3>
        <button style="margin-bottom: 10px;" class="btn btn-danger delete_all center-block justify-content-center" data-url="{{ url('myproductDeletewifi') }}">Delete All Selected</button>
            ...
            @if($wifi->count())
                @foreach($paginate as $key => $product)
                    <tr id="tr_{{$product->id}}">
                        ...
                        <td>
                            <a href="{{ url('myproductswifi',$product->id) }}" class="btn btn-danger btn-sm"
