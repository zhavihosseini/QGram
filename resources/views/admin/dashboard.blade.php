...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link href="AdMinn/css/metisMenu.min.css" rel="stylesheet">

    <!-- Timeline CSS -->
    <link href="AdMinn/css/timeline.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="AdMinn/css/startmin.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="AdMinn/css/morris.css" rel="stylesheet">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<?php echo route('usersz')?>"><i class="fa fa-edit fa-fw"></i> USERS</a>
                    </li>
                    <li>
                        <a href="<?php echo route('news')?>"><i class="fa fa-newspaper-o"></i> NEWS</a>
                    </li>
                </ul>
            </div>
        </div>
...
<script src="AdMinn/js/metisMenu.min.js"></script>

<!-- Morris Charts JavaScript -->
<script src="AdMinn/js/raphael.min.js"></script>
<script src="AdMinn/js/morris.min.js"></script>
<script src="AdMinn/js/morris-data.js"></script>

<!-- Custom Theme JavaScript -->
<script src="AdMinn/js/startmin.js"></script>
