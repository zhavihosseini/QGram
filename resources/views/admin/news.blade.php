...
@else
    <div class="container" style="overflow-x: auto;max-width: 100%">
        <h3 style="text-align: center">Multiple Deleted <strong>News ({{$countss}}) </strong> Row</h3>
        <button style="margin-bottom: 10px;" class="btn btn-danger delete_all center-block justify-content-center" data-url="{{ url('myproductDeletenewsz') }}">Delete All Selected</button>
        <table class="table table-bordered">
            <tr style="vertical-align: middle">
                ...
                <th style="vertical-align: middle">urltoimage</th>
                <th style="vertical-align: middle">publishat</th>
            ...
            @if($news->count())
                @foreach($paginate as $key => $product)
                    <tr id="tr_{{$product->id}}">
                        ...
                        <td style="vertical-align: middle"><img src="{{$product->urltoimage}}" width="120px" height="120px"></td>
                        ...
                        <td style="vertical-align: middle">{{ $product->urltoimage}}</td>
                        <td style="vertical-align: middle">{{ $product->publishat}}</td>
                        <td style="vertical-align: middle">{{ $product->content}}</td>
                        <td style="vertical-align: middle">
                            <a href="{{ url('myproductsnewsz',$product->id) }}" class="btn btn-danger btn-sm"
