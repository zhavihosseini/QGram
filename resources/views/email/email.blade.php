...
<x-app-layout>
    ...
    <div class="container" id="cont">
        <div class="row col-md-12" style="margin-left: 0px;padding: 0px">
            <div class="col-md-12">
                <strong>Create Your Email QR Code</strong>
                <br>
                <form action="<?php echo route('emailsub')?>" method="post">
                    <?php
                    echo csrf_field();
                    ?>
                    <div class="form-group">
                        <label for="email">Email:</label>
                        <input type="email" class="form-control bx-bitcoin" id="email" placeholder="Enter Your Email..." name="email" max="255"/>
                    </div>
                    <div class="form-group">
                        <label for="subject">Subject:</label>
                        <input type="text" class="form-control bx-bitcoin" id="subject" placeholder="Enter Your subject..." name="subject" max="255"/>
                    </div>
                    <div class="form-group">
                        <label for="message">Message:</label>
                        <input type="text" class="form-control bx-bitcoin" id="message" placeholder="Enter Your message..." name="message" max="255"/>
                    </div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-10 col-md-10">
                                                        ...
                                                        <div class="action">
                                                            <form method="get" action="<?php echo route('emailedit',['id'=>$id])?>" class="inline-flex">
                                                                @csrf
                                                                    ...
                                                                    <div class="modal-dialog modal-lg">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-footer justify-content-between">
                                                                                ...
                                                                                <form method="get" action="<?php echo route('deleteemail',['ids'=>$id])?>">
