...
<ul>
    ...
    <li>
        <p><strong>Website</strong> refers to Q Gram, accessible from <a href="<?php echo route('home')?>" rel="external nofollow noopener" target="_blank">Q Gram</a></p>
    </li>
    <li>
...
<ul>
    <li>By visiting this page on our website: <a href="<?php echo route('term')?>" rel="external nofollow noopener" target="_blank">Term-Of-Use</a></li>
</ul>
</div>
</body>
