...
<x-app-layout>
    ...
    <div class="container" id="cont">
        <div class="row col-md-12" style="margin-left: 0px;padding: 0px">
            <div class="col-md-12">
                <strong>Create Your Phone Number QR Code</strong>
                <br>
                <form action="<?php echo route('phonenumber')?>" method="post">
                    <?php
                    echo csrf_field();
                    ?>
                    <div class="form-group">
                        <label for="phone">Phone Number:</label>
                        <input type="text" class="form-control bx-bitcoin" id="phone" placeholder="Enter Your Phone Number" name="phone" max="255"/>
                    </div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-10 col-md-10">
                                                        ...
                                                        <div class="action">
                                                            <form method="get" action="<?php echo route('editsphone',['id'=>$id])?>" class="inline-flex">
                                                                @csrf
                                                                    ...
                                                                    <div class="modal-dialog modal-lg">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-footer justify-content-between">
                                                                                ...
                                                                                <form method="get" action="<?php echo route('deleted',['ids'=>$id])?>">
