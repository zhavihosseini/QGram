<meta charset="utf-8">
<link ref="stylesheet" type="text/css" href="public/diist/dist/snackbar.min.css" /> <script src="public/diist/dist/snackbar.min.js"></script>
...
<x-app-layout>
    ...
    <div class="container" id="cont">
        <div class="row col-md-12" style="margin-left: 0px;padding: 0px">
            <div class="col-md-12">
                <strong>Create Your Geo Location QR Code</strong>
                <br>
                <form action="<?php echo route('geolocation')?>" method="post">
                    <?php
                    echo csrf_field();
                    ?>
                    <div class="form-group">
                        <label for="latitude">Latitude:</label>
                        <input type="text" class="form-control bx-bitcoin" id="latitude" placeholder="Enter Latitude..." name="latitude" max="255"/>
                    </div>
                        <div class="form-group">
                            <label for="longitude">Longitude:</label>
                            <input type="text" class="form-control bx-bitcoin" id="longitude" placeholder="Enter Longitude..." name="longitude" max="255"/>
                        </div>
                        <div class="form-group">
                            <label for="describe">Description:</label>
                            <input type="text" class="form-control bx-bitcoin" id="describe" placeholder="Enter Description..." name="describe" max="255"/>
                        </div>
                        ...
                        <div class="panel panel-default widget col-md-12">
                            ...
                            @else
                                @foreach($all as $alls)
                                    @php
                                        $qr = $alls['qr'];
                                        $latidude = $alls['latitude'];
                                        $longitude = $alls['longitude'];
                                        $describe = $alls['describe'];
                                        $time = $alls['time'];
                                        $idd = $alls['id'];
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-10 col-md-10">
                                                        ...
                                                        <div class="action">
                                                            <form method="get" action="<?php echo route('geoedit',['id'=>$id])?>" class="inline-flex">
                                                                @csrf
                                                                    ...
                                                                    <div class="modal-dialog modal-lg">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-footer justify-content-between">
                                                                                ...
                                                                                <form method="get" action="<?php echo route('deleteits',['ids'=>$id])?>">
