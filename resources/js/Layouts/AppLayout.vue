                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <jet-nav-link :href="route('bitcoin')" :active="route().current('bitcoin')">
                                Bitcoin
                            </jet-nav-link>
                            <jet-nav-link :href="route('message')" :active="route().current('message')">
                                Message
                            </jet-nav-link>
                            <jet-nav-link :href="route('phone')" :active="route().current('phone')">
                                Phone
                            </jet-nav-link>
                            <jet-nav-link :href="route('geo')" :active="route().current('geo')">
                                Geo
                            </jet-nav-link>
                            <jet-nav-link :href="route('email')" :active="route().current('email')">
                                Email
                            </jet-nav-link>
                            <jet-nav-link :href="route('url')" :active="route().current('url')">
                                Url
                            </jet-nav-link>
                            <jet-nav-link :href="route('scanner')" :active="route().current('scanner')">
                                Scanner
                            </jet-nav-link>
                        </div>
                    </div>
